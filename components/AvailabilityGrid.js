...
// 4-stop heat gradient — dark=low demand, purple=high demand:
//   #1e3a8a (מעט ביקוש) → #739ee7 (מתאים) → #9ac0ff → #8c52ff (כרגע מוביל)
const HEAT_STOPS = [
  [ 30,  58, 138],   // #1e3a8a — dark navy    (low,  מעט ביקוש)
  [115, 158, 231],   // #739ee7 — medium blue  (mid1, מתאים)
  [154, 192, 255],   // #9ac0ff — light blue   (mid2)
  [140,  82, 255],   // #8c52ff — purple        (max,  כרגע מוביל)
];
