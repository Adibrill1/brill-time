...
// 4-stop heat gradient — dark=low demand, green=high demand:
//   #1e3a8a (מעט ביקוש) → #739ee7 (יותר מתאים) → #9ac0ff (מאוד מתאים) → #00d26a (כרגע מוביל)
const HEAT_STOPS = [
  ...
  [  0, 210, 106],   // #00d26a — green         (max,  כרגע מוביל)
];
